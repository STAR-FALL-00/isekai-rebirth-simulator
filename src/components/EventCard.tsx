...
export default function EventCard({ age, text, effects, color = '#D4A843' }: EventCardProps) {
  ...
  return (
    <motion.div
      ...
      className="bg-bg-secondary border border-border-subtle rounded-xl p-5 shadow-lg"
    ...
    >
      ...
      <p className="text-base font-body text-text-primary leading-relaxed mb-3" style={{ whiteSpace: 'pre-wrap' }}>{text}</p>
